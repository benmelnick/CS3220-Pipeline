...
HD_PWD='/home/bmelnick3/cs3220/CS3220-Pipeline/Assignment5/MultVivado/MultVivado.runs/design_1_mulBF16_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mulBF16_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mulBF16_0_0.tcl
